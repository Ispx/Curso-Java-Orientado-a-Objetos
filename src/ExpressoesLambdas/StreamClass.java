...
public class StreamClass {
	...
	static void filterNoStream(List<String> list, Predicate<String> predicate) {
		...
		list.forEach( x -> { if( predicate.test(x ) == true ) { System.out.println(x) ;} ;} );
	...
	public static void main(String[] args) {
		...
		List<String> capital = Arrays.asList("São Paulo","Belo Horizonte","Santa Catarina","Rio de Janeiro", "Vitória","Palmas","Acre","Curitiba","Distrito Federal","Salvador","Manaus");
